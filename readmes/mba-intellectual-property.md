<!-- repo: https://github.com/nikbearbrown/mba-intellectual-property | stars: 0 | updated: 2026-06-07T02:04:42Z -->
...
The first sign of trouble is usually not failure. It is fluency. The draft looks clean. The answer sounds reasonable. The chart has labels. The code runs. The plan has phases. The explanation has the rhythm of expertise. Nothing in the surface announces that a human still has work to do. This book is about the gap between a polished artifact and a trustworthy one. The central argument of **Introduction to Intellectual Property: with LLMs** is that readers need a working method for the part of the work that cannot...

## Table of Contents

- [Front Matter](chapters/00-frontmatter.md)
- [Introduction](chapters/00-introduction.md)
- [Chapter 1 — Patent Basics](chapters/01-patent-basics.md)
- [Chapter 2 — Patent Enforcement](chapters/02-patent-enforcement.md)
- [Chapter 3 — Copyright Basics](chapters/03-copyright-basics.md)
- [Chapter 4 — Trademark Basics](chapters/04-trademark-basics.md)
- [Chapter 5 — Trade Secret Basics](chapters/05-trade-secret-basics.md)
