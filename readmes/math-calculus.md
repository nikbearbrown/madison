<!-- repo: https://github.com/nikbearbrown/math-calculus | stars: 0 | updated: 2026-06-07T02:04:25Z -->
...
The first sign of trouble is usually not failure. It is fluency. The draft looks clean. The answer sounds reasonable. The chart has labels. The code runs. The plan has phases. The explanation has the rhythm of expertise. Nothing in the surface announces that a human still has work to do. This book is about the gap between a polished artifact and a trustworthy one. The central argument of **Calculus: with LLMs** is that readers need a working method for the part of the work that cannot be delegated: the...

## Table of Contents

- [Front Matter](chapters/00-frontmatter.md)
- [Introduction](chapters/00-introduction.md)
- [Chapter 1 — Functions and Graphs](chapters/01-functions-and-graphs.md)
- [Chapter 2 — Limits](chapters/02-limits.md)
- [Chapter 3 — Derivatives](chapters/03-derivatives.md)
- [Chapter 4 — Applications of Derivatives](chapters/04-applications-of-derivatives.md)
- [Chapter 5 — Integration](chapters/05-integration.md)
- [Chapter 6 — Applications of Integration](chapters/06-applications-of-integration.md)
