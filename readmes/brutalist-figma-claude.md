<!-- repo: https://github.com/nikbearbrown/brutalist-figma-claude | stars: 1 | updated: 2026-06-07T02:04:02Z -->
...
The first sign of trouble is usually not failure. It is fluency. The draft looks clean. The answer sounds reasonable. The chart has labels. The code runs. The plan has phases. The explanation has the rhythm of expertise. Nothing in the surface announces that a human still has work to do. This book is about the gap between a polished artifact and a trustworthy one. The central argument of **Brutalist Figma + Claude** is that readers need a working method for the part of the work that cannot be delegated:...
