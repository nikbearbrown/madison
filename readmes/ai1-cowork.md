<!-- repo: https://github.com/nikbearbrown/ai1-cowork | stars: 0 | updated: 2026-06-10T21:23:34Z -->
...
- `images/ai1-cowork-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/ai1-cowork-fig-NN.html` — interactive D3 HTML
